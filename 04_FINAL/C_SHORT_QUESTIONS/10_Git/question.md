...
How do you delete a local branch after completing work on it.  How would you delete a remote branch?
    ...
    ANSWER:
        Use git checkout to move OFF the branch you want to delete. Then type the command 
            "git branch -delete <nameOfBranch>"
        Then run "git branch -a" to see if its deleted

        To delete a remote branch 
            "git push orgin --delete <nanmeOfBranch>"
